...
//---------------------------------------------------------------------------------
//
extern "C"  void LO_sock_disconnect(void** pHdl)
{
    if (pHdl != NULL) {
...
//---------------------------------------------------------------------------------
//
extern "C" void* LO_sock_connect( short retry, const char* remoteHostAddress, uint16_t remoteHostPort)
{
    int ret;
    int i;
    TCPSocket* pTcpSock;
...
//---------------------------------------------------------------------------------
//
extern "C" int LO_sock_send(void* hdl, const char* buf_ptr)
{
...
//---------------------------------------------------------------------------------
//
extern "C" int LO_sock_recv(void* hdl, char* buf_ptr, int buf_len)
{
    int ret ;
    TCPSocket* pTcpSock =  (TCPSocket *) hdl;
    if (pTcpSock == NULL) {
...
//---------------------------------------------------------------------------------
//
extern "C" int LO_sock_read_line(void* hdl, char* buf_ptr, int buf_len)
{
    int len = 0;
    short retry = 0;
    char cc;

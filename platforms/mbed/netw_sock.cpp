...
//---------------------------------------------------------------------------------
//
extern "C" uint8_t f_netw_sock_isOpen( void *ctx )
{
...
//---------------------------------------------------------------------------------
//
extern "C" uint8_t f_netw_sock_isLost( void *ctx )
{
    if ((_netw_socket)  && (_netw_bSockState &0x01)) {
...
//---------------------------------------------------------------------------------
//
extern "C" int f_netw_sock_setup( void *ctx )
{
    if (_netw_socket) {
...
//---------------------------------------------------------------------------------
//
extern "C" int f_netw_sock_close( void *ctx )
{
    if (_netw_socket) {
...
//---------------------------------------------------------------------------------
//
extern "C" int f_netw_sock_connect(void **pSockHdl, const  char* RemoteHostAddress, uint16_t RemoteHostPort, uint32_t tmo_ms)
{
    int ret;
    ...
    if (_netw_socket) {
        f_netw_sock_close(_netw_socket);
    }
    _netw_bSockState = 0;
...
//---------------------------------------------------------------------------------
//
extern "C" int f_netw_sock_init( void *pNetwork,  void* net_iface_handler)
{
